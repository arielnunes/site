...
function magicScroll(){
	...
	/**
	  ...
	  handler: function(direction) {
		  	if (direction === 'down') {
		    TweenMax.to("#logo-arielnunes", 0.25, {opacity:0, ease:Strong.easeInOut});
		    	//TweenMax.to("#logo-arielnunes", 0.25, {opacity:1, ease:Strong.easeInOut});
		    console.log('Down')
		    }
		   	if (direction === 'up') {
		    TweenMax.to("#logo-arielnunes", 0.25, {opacity:1, ease:Strong.easeInOut});
...
/**
  ...
  // Init ScrollMagic Controller
	...
	var tween1 = new TimelineMax();
		...
		tween1.to([navToggle], 0.1, {opacity: 0, ease:Strong.easeInOut})
		.to([navBlackColor], 0.1, {opacity: 1, ease:Strong.easeInOut});
		
	
	// Create the Scene and trigger when visible
	var scene1 = new ScrollMagic.Scene({
	triggerElement: '.bg-white',
	})
	...
	tween2.to([navBlackColor], 0.1, {opacity: 0, ease:Strong.easeInOut})
		.to([navToggle], 0.1, {opacity: 1, ease:Strong.easeInOut});
		
	// Create the Scene and trigger when visible
	var scene2 = new ScrollMagic.Scene({
	triggerElement: '.bg-black',
	})
